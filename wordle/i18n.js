export const translations = {
  en: {
    ...
    instructions: 'How the study works', rules: [
      ...
      'After six guesses and their feedback, you may give up the word. This counts as an unsuccessful round.',
    ...
    solved: 'You found the word.', exhausted: 'You have used all 10 guesses.', surrendered: 'You gave up this word.', answer: 'The word was', next: 'Next word', practiceDone: 'Finish practice', blockDone: 'Finish study', surrender: 'Give up this word', surrenderHelp: 'Available after six guesses and their feedback.', surrenderConfirm: 'Give up this word? It will count as an unsuccessful round.',
  ...
  de: {
    ...
    instructions: 'So funktioniert die Studie', rules: [
      ...
      'Nach sechs Versuchen und den zugehörigen Hinweisen können Sie das Wort aufgeben. Die Runde zählt dann als nicht gelöst.',
    ...
    solved: 'Sie haben das Wort gefunden.', exhausted: 'Sie haben alle 10 Versuche verbraucht.', surrendered: 'Sie haben dieses Wort aufgegeben.', answer: 'Das Wort war', next: 'Nächstes Wort', practiceDone: 'Übung abschließen', blockDone: 'Studie abschließen', surrender: 'Dieses Wort aufgeben', surrenderHelp: 'Nach sechs Versuchen und den Hinweisen verfügbar.', surrenderConfirm: 'Dieses Wort aufgeben? Die Runde zählt dann als nicht gelöst.',
