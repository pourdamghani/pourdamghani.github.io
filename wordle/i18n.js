export const translations = {
  ...
  de: {
    ...
    startPractice: 'Übung starten', practice: 'Übung', ready: 'Bereit für die Studie?', readyText: 'Die Übung ist beendet. Starten Sie, wenn Sie bereit sind: Mit dem ersten Studienwort beginnt die 100-Minuten-Uhr. Sie läuft bis zum Ende des Studienblocks weiter.', start: 'Die 20 Studienwörter starten', notStarted: 'Noch nicht gestartet', untimed: 'Ohne Zeitlimit', round: 'Runde', of: 'von', guessesLeft: 'Versuche übrig',
